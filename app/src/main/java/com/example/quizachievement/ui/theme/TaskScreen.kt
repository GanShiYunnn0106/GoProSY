...
import com.example.quizachievement.SystemBackButtonHandler
import com.example.quizachievement.model.Task
...
fun TaskScreen(){
        ...
        LazyColumn {
            item {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    IconButton(
                        onClick = { GoProAppRoute.navigateTo(Screen.StudentDashboard) }
                    ) {
                        Icon(
    ...
    SystemBackButtonHandler {
        GoProAppRoute.navigateTo(Screen.StudentDashboard)
    }
}
